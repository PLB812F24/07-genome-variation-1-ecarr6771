...
library(ggplot2)
setwd("/Users/eleanor/Documents/Fall2024/PLB812/Homework/07-genome-variation-1-ecarr6771/")
```
...
ggplot(penguins, aes(body_mass_g)) + 
  geom_histogram(binwidth = 100, color = 'white', fill = 'purple4') +
...
This changes from discrete colors (e.g. red, green, pink) to a gradient because this is a continuous variable. It's cool looking!
```{r}
